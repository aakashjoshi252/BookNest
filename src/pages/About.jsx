...
export default function About() {
    ...
    // Values data
    const values = [
        {  title: "Curated Selection", desc: "We carefully select every title in our store, ensuring quality and diversity across all genres." },
        {  title: "Community Focus", desc: "We're committed to being an active, positive force in our local community." },
        {  title: "Sustainability", desc: "We prioritize eco-friendly practices and support sustainable publishing initiatives." },
        {  title: "Personal Service", desc: "Our knowledgeable staff provides personalized recommendations." },
        {  title: "Literary Discovery", desc: "We champion emerging authors and help readers discover their next favorite book." },
        {  title: "Local First", desc: "We support local authors and businesses through partnerships and promotions." }
    ];
        ...
        <main className="container py-5">
            ...
            <section className="row align-items-center mb-5">
                <div className="col-md-6">
                    ...
                    <p>What started as a modest operation in a 500-square-foot storefront has grown into one of the region's most beloved bookstores.</p>
                    <a href="../index.html" className="btn btn-primary">Visit Our Store</a>
                </div>
                <div className="col-md-6">
                    <img className="img-fluid rounded shadow" src="https://images.unsplash.com/photo-1589998059171-988d887df646?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" alt="Our original store" />
                </div>
            </section>
            ...
            <section className="row align-items-center mb-5 flex-row-reverse">
                <div className="col-md-6">
                    ...
                    <p>We're more than just a bookstore - we're a community hub where book lovers can discover new titles, meet authors, and share their passion.</p>
                </div>
                <div className="col-md-6">
                    <img className="img-fluid rounded shadow" src="https://images.unsplash.com/photo-1507842217343-583bb7270b66?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" alt="Bookstore interior" />
                </div>
            </section>
                ...
                <div className="row">
                    {team.map((member, i) => (
                        <div className="col-md-3 text-center mb-4" key={i}>
                            <img src={member.img} alt={member.name} className="rounded-circle mb-4 img-fluid shadow" />
                            <h5>{member.name}</h5>
                    ...
                    {values.map((val, i) => (
                        <div className="col-md-4 mb-4" key={i}>
                            <div className="card text-center shadow h-100 p-3">
                                <div className="fs-1">{val.icon}</div>
